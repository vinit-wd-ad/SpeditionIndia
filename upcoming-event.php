            ...
            <div class="row row-gap-5">
              <div class="col-lg-8">
                <div class="post-details-wrapper">
                  <h2 class="title title-anim">Global Freight Forwarders Conference</h2>
                  <div class="blog-text">
                    <!-- <h3 class="wow fadeInUp" data-wow-delay=".3s">Event Galley</h3> -->
                    <div class="images-wrap">
                      <div class="row">
                        <div class="col-12">
                          <img src="https://www.speditionindia.com/wp-content/uploads/2024/11/WhatsApp-Image-2024-11-04-at-1.57.30-PM.jpeg" alt="" class="w-100 rounded">
                        </div>
                      </div>
                    </div>
                  </div>
