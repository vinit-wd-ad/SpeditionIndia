  ...
  <div id="smooth-wrapper">
    <div id="smooth-content">
      <main id="primary" class="site-main">
              ...
              <div class="col-xl-6 col-lg-6 order-lg-1 order-2 scroll-anim-right">
                <div class="about-img-area wow fadeInLeft" data-wow-delay=".2s">
                  <div class="about-img overflow-hidden pe-lg-5">
                    <img data-speed="0.8" src="assets/images/about/about6d.png" alt>
                  </div>
                  <div class="box-area">
                    <div class="experience-box wow fadeInUp" data-wow-delay=".3s">
                      ...
                      <h6 class="customers-text">Decades of Experience,
                        Endless Innovation</h6>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 col-lg-6 order-lg-2 order-1 scroll-anim-left">
                <div class="about-content-area style-1 wow fadeInLeft" data-wow-delay=".2s">
                  <div class="sec-heading">
                    <span class="sub-title wow fadeInUp" data-wow-delay=".3s"><i class="tji-box"></i>Get to Know
                      Us</span>
                    <h2 class="sec-title title-highlight">Global Logistics
                      Expertise with Trusted Warehousing
                      <span>Solutions</span>
                    </h2>
                  </div>
                ...
                <div class="about-bottom-area">
                  <div class="client-review-cont scroll-anim-left" data-wow-delay=".7s">
                    ...
                    <p class="desc mb-2">At Spedition we have started our journey in April 2018, notwithstanding we have more than 15 years of experience prior to the foundation of our organization, which we have successfully achieved by completing more than International 1000 Exhibition Logistics & other international projects.</p>
                    <!-- <div class="client-info-area">
                      <div class="client-info">
                        <h6 class="title">HARPREET SINGH</h6>
                  ...
                  <div class="video-img  scroll-anim-left" data-wow-delay=".9s">
                    <img src="assets/images/logos/logo-png.png" alt>
                    <!-- <a class="video-btn video-popup" data-autoplay="true" data-vbtype="video" data-maxwidth="1200px" 
                            href="https://www.youtube.com/watch?v=6wrB-FdT7uc">
        ...
        <?php include "components/service-section1.php" ?>
        <!-- end: Service Section -->
            ...
            <div class="row row-gap-4">
                ...
                <div class="about-content-area-2 scroll-anim-left" data-wow-delay=".3s">
                  <div class="about-content">
                    <div class="sec-heading style-2">
                      ...
                      <h2 class="sec-title title-highlight">Driving into
                        Excellence & Innovation: Your Trusted Partner
                        for
                  ...
                  <div class="video-img scroll-anim-left" data-wow-delay=".7s">
                    <img src="assets/images/about/import-export.webp" alt="Image">
                    <a class="video-btn video-popup" data-autoplay="true" data-vbtype="video" data-maxwidth="1200px"
                      href="https://www.youtube.com/watch?v=d3LtCIhCJKU">
                      <span><i class="tji-play"></i></span>
                    </a>
              ...
              <div class="col-lg-4 col-md-6 order-lg-3 order-2">
                <div class="customers-box style-2 scroll-anim-right" data-wow-delay=".3s">
                  ...
                  <div class="star-icon zoomInOut"><img src="assets/images/shape/star.svg" alt></div>
                </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 order-lg-5 order-5">
                <div class="countup-item style-2 scroll-anim-left" data-wow-delay=".7s">
                  ...
                  <div class="count-inner">
                    ...
                    <div class="inline-content">
                      <span class="odometer countup-number" data-count="150"></span>
                      <span class="count-plus">+</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="sec-heading-wrap">
                  <div class="heading-wrap-content">
                    <div class="sec-heading style-8">
                      <span class="sub-title wow fadeInUp text-white" data-wow-delay=".3s">Types of Logistics</span>
        ...
        <?php #include "components/client-section1.php"; ?>
        <!-- end: Client Section -->
      </main>
